...
public class UserCustomResource {
     ...
     * or with status 500 (Internal Server Error) if the userCustom couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    public ResponseEntity<UserCustom> getUserCustom(@PathVariable Long id) {
        ...
        UserCustom userCustom = userCustomRepository.findOneWithEagerRelationships(id);
