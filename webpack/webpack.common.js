...
const METADATA = {
    title: 'Great Big Example Application',
    baseUrl: '/',
...
module.exports = function(options) {
    ...
    return {
        ...
        entry: {
            ...
            'main': AOT ? './src/main/webapp/main.browser.aot.ts' :
                './src/main/webapp/main.browser.ts'
        ...
        module: {
            ...
            rules: [
                 ...
                 */
                {
                    test: /\.html$/,
                    use: 'raw-loader',
                    exclude: [helpers.root('src/main/webapp/index.html')]
                },
        ...
        plugins: [
            ...
            new ContextReplacementPlugin(
                ...
                helpers.root('src/main/webapp/app'), // location of your src
                {
                    /**
